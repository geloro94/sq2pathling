...
class TranslatorTest {
  ...
  static final TermCode CONTEXT_CONSENT = TermCode.of("fdpg.mii.cds", "Einwilligung",
      "Einwilligung");
  ...
  class ToPathlingTest {
    ...
    void nonExpandableConcept() {
      ...
      var message = assertThrows(TranslationException.class,
          () -> Translator.of().toPathling(structuredQuery)).getMessage();
    ...
    void usage_Documentation() throws JsonProcessingException, JSONException {
      ...
      JSONAssert.assertEquals("""
              ...
              }""", new ObjectMapper().writerWithDefaultPrettyPrinter().writeValueAsString(parameters),
    ...
    void timeRestriction_missingPathInMapping() {
      ...
      var query = StructuredQuery.of(
          List.of(List.of(ConceptCriterion.of(ContextualConcept.of(c71_1),
              TimeRestriction.of("2020-01-01T", "2020-01-02T")))));
    ...
    void test_Task1() throws JsonProcessingException, JSONException {
      var mappings = Map.of(PLATELETS,
          Mapping.of(PLATELETS, "Observation", "code.coding", "value", "Quantity"), C71_0,
      ...
      var structuredQuery = StructuredQuery.of(List.of(List.of(concept),
          List.of(
              NumericCriterion.of(ContextualConcept.of(PLATELETS), LESS_THAN,
    ...
    void test_Task2() throws JsonProcessingException, JSONException {
      var mappings = Map.of(PLATELETS, Mapping.of(PLATELETS, "Observation", "value"), HYPERTENSION,
          Mapping.of(HYPERTENSION, "Condition", "code.coding", null, null, List.of(),
              List.of(VERIFICATION_STATUS_ATTR_MAPPING)), SERUM, Mapping.of(SERUM, "Specimen"),
          LIPID,
    ...
    @Test
    void geccoTask2() throws JsonProcessingException, JSONException {
      var mappings = Map.of(FRAILTY_SCORE,
          Mapping.of(FRAILTY_SCORE, "Observation", "code.coding", "value", "Coding"), COPD,
          ...
          Mapping.of(TOBACCO_SMOKING_STATUS, "Observation", "code.coding", "value.coding",
              "Coding"));
      var conceptTree = TermCodeNode.of(ROOT, TermCodeNode.of(COPD), TermCodeNode.of(G47_31));
      var mappingContext = MappingContext.of(mappings, conceptTree);
      var structuredQuery = StructuredQuery.of(
          List.of(
              List.of(ValueSetCriterion.of(ContextualConcept.of(FRAILTY_SCORE), VERY_FIT, WELL))),
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(reverseResolve(Observation.subject).exists(code.coding.where(system = 'http://snomed.info/sct').exists(code = '713636003') and\\n(value.where(system = 'https://www.netzwerk-universitaetsmedizin.de/fhir/CodeSystem/frailty-score').exists(code = '1') or\\nvalue.where(system = 'https://www.netzwerk-universitaetsmedizin.de/fhir/CodeSystem/frailty-score').exists(code = '2'))))"
            }, {
              "name" : "filter",
              "valueString" : "(reverseResolve(Condition.subject).exists(code.coding.where(system = 'http://snomed.info/sct').exists(code = '13645005') and\\n(verificationStatus.coding.coding.where(system = 'http://terminology.hl7.org/CodeSystem/condition-ver-status').exists(code = 'confirmed')))) and\\n(reverseResolve(Condition.subject).exists(code.coding.where(system = 'http://fhir.de/CodeSystem/bfarm/icd-10-gm').exists(code = 'G47.31') and\\n(verificationStatus.coding.coding.where(system = 'http://terminology.hl7.org/CodeSystem/condition-ver-status').exists(code = 'confirmed')))) or\\n(reverseResolve(Observation.subject).exists(code.coding.where(system = 'http://loinc.org').exists(code = '72166-2') and\\n(value.coding.where(system = 'http://loinc.org').exists(code = 'LA18976-3')))).not()"
            } ],
            "resourceType" : "Parameters"
          }
          """, json, JSONCompareMode.LENIENT);
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(reverseResolve(Consent.subject).exists(status = 'active' and\\n(provision.provision.code.coding.coding.where(system = 'urn:oid:2.16.840.1.113883.3.1937.777.24.5.3').exists(code = '2.16.840.1.113883.3.1937.777.24.5.3.5')) and\\n(provision.provision.code.coding.coding.where(system = 'urn:oid:2.16.840.1.113883.3.1937.777.24.5.3').exists(code = '2.16.840.1.113883.3.1937.777.24.5.3.2'))))"
            } ],
            "resourceType" : "Parameters"
          }
          """, json, JSONCompareMode.LENIENT);
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(birthDate <= @2019-01-23)"
            } ],
            "resourceType" : "Parameters"
          }""", json, JSONCompareMode.LENIENT);
    }
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(birthDate >= @2014-01-23 and\\nbirthDate <= @2019-01-23)"
            } ],
            "resourceType" : "Parameters"
          }""", json, JSONCompareMode.LENIENT);
    }
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(birthDate >= @2023-08-23)"
            } ],
            "resourceType" : "Parameters"
          }""", json, JSONCompareMode.LENIENT);
    }
      ...
      JSONAssert.assertEquals("""
          {
            "parameter" : [ {
              ...
              "name" : "filter",
              "valueString" : "(reverseResolve(Consent.subject).exists(provision.provision.code.where(system = 'urn:oid:2.16.840.1.113883.3.1937.777.24.5.3').exists(code = '2.16.840.1.113883.3.1937.777.24.5.3.8')))"
            } ],
            "resourceType" : "Parameters"
          }""", json, JSONCompareMode.LENIENT);
    }
